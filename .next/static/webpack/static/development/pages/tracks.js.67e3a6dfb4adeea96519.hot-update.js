...
function (_React$Component) {
  ...
  function Tracks(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "createTrackInfoObject", function (audioFeatures) {
      var tracklist = _this.state.tracks; // console.log(tracklist);
      ...
      var isThisAnArray = _this.trackObjects.map(function (track, index) {
        return {
      ...
      console.log({
        isThisAnArray: isThisAnArray
      });
      console.log({
        isThisTheSameDataShape: isThisTheSameDataShape
      });

      _this.setState({
        trackObjects: isThisAnArray
      });
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Tracks, [{
    ...
    value: function render() {
      var ctx = typeof window !== 'undefined' && typeof window !== 'undefined' && document.getElementById('myChart') && document.getElementById('myChart').getContext("2d");
      var scatterChart = typeof window !== 'undefined' && this.state.trackObjects !== null && new chart_js__WEBPACK_IMPORTED_MODULE_11___default.a(ctx, {
        type: 'scatter',
        data: {
...
//# sourceMappingURL=tracks.js.67e3a6dfb4adeea96519.hot-update.js.map